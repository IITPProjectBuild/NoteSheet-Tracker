...
export default function UnstyledTabsIntroduction({ onTabChange }) {
  ...
  return (
    <Tabs value={id} onChange={handleTabChange} aria-label="tabs" className='flex flex-col items-center justify-evenly mr-8'>
      <TabsList className='w-3/5 flex flex-col justify-evenly p-4 border-b'>
        <span className='w-full flex justify-evenly p-4 border-b'>
          <Tab value={0} className='flex-1 justify-around'><p>Pending</p></Tab>
          <Tab value={1} className='flex-1 justify-around'><p>Approved</p></Tab>
          <Tab value={2} className='flex-1 justify-around'><p>Rejected</p></Tab>
        </span>
      </TabsList>
