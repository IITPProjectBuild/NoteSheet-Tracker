...
const Navbar = () => {
    ...
    return (
        <>
            {console.log(email)}
            <nav className="bg-blue-950 w-full text-lg">
                    ...
                    <div className="flex-grow flex justify-center order-3 md:order-none mt-4 md:mt-0">
                        <ul className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-8 text-center font-medium">
                            <li>
                                <a
                                    href="homepage"
                                    className="block py-2 px-3 text-white bg-blue-950 rounded md:bg-transparent md:text-white hover:font-bold"
                                    aria-current="page"
                                >
                                    Home
                                </a>
                            ...
                            <li>
                                <Link
                                    href="Template"
                                    className="block py-2 px-3 text-white rounded hover:bg-blue-950 md:hover:bg-transparent md:border-0 md:hover:font-bold"
                                >
                                    My Notesheet
                                </Link>
                            </li>
