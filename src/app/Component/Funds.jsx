    ...
    return (
        <>
            <div className="flex flex-col items-center p-4">
                ...
                <div
                    className="w-44 h-44 rounded-full bg-[conic-gradient(from_0deg,_#ff264a_0deg_50deg,_#feec1e_50deg_360deg)]"
                    style={{
                        background: `conic-gradient(from 0deg, #ff264a 0deg ${budgetPercentage}deg, #feec1e ${budgetPercentage}deg ${
                            budgetPercentage + fundsPercentage
                        }deg)`,
                    }}
                ></div>
